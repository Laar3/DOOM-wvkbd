...
static struct key keys_nav[] = {
  ...
  {"⇇", "⇇", 1.0, Code, KEY_R, .scheme = 1},
  {"Crouch", "Crouch", 1.0, Code, KEY_4, .scheme = 1},
  {"⇉", "⇉", 1.0, Code, KEY_L, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"Shoot", "Shoot", 1.0, Code, KEY_ENTER, .scheme = 1},
  {"Use", "Use", 1.0, Code, KEY_B, .scheme = 1},
  {"Jump", "Jump", 1.0, Code, KEY_SPACE, .scheme = 1},
  {"↑", "↑", 1.0, Code, KEY_UP, .scheme = 1},
  {"Reload", "Reload", 1.0, Code, KEY_N, .scheme = 1},
  {"", "", 0.0, EndRow},
